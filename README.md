...
A quick start Vue project that shows how to group nodes and connectors in the [Vue Diagram](https://www.syncfusion.com/diagram-sdk/vue-diagram) component. This project includes code snippets to create and update groups dynamically. It also includes code snippets to add annotations to a group and create a nested group.
